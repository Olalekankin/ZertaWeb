  ...
  return (
    <div className='p-4 mt-28 md:p-0 md:px-12 md:py-8 lg:px-24 lg:py-16 bg-cream'>
      ...
      <div className='mt-8 lg:mt-14'>
        <div>
          <p className='text-3xl lg:text-4xl xl:text-6xl tracking-widest leading-8 lg:leading-[90px]  font-ribeye'>
      ...
      <div className='w-full flex justify-center '>
        <form
          ...
          className='lg:w-2/4 lg:px-12  lg:container lg:mx-auto mt-12 bg-white rounded-lg py-6 px-4  md:p-8 flex flex-col md:ml-auto w-full border-t-4 text-tblack font-roboto border-bgreen shadow-md'
        >
          <h2 className='text-lg mb-8 font-medium font-roboto'>
            Fill out the form
          </h2>
          <p className='text-white bg-bgreen flex items-center space-x-2 border-0 py-2 px-6 focus:outline-none hover:bg-green-500 rounded-full justify-center text-lg'>
            {response}
          </p>{' '}
          <br></br>
